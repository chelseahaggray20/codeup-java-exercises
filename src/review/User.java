...
//    /* Write the constructor on `User` that defines 3 parameters: the first name for the person, the last name and a boolean indicating whether or not that user is an administrator. The corresponding properties of the object
...
public String isAdmin() {
    this.getfirstName();
    this.getlastName();
    this.admin = getfirstName() + getlastName();
    return admin;
}